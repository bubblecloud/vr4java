...
/**
 * GoogleSpeechService class that connects to Google's unoffical API to retrieve data
...
public class GoogleSpeechService {
	 ...
	 */
	private final static String GOOGLE_AUTODETECT_URL =
            "https://translate.google.com/translate_a/t?client=t&sl=auto&text=";
	 ...
	 */
	public GoogleSpeechService(final String languageCode){
		this.languageCode = languageCode;
	}

	/**
	 * Returns the current language code for the GoogleSpeechService.
