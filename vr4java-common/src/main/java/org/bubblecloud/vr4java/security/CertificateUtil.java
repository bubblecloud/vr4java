...
public class CertificateUtil {
    ...
    /**
     * The key store security provider.
     */
    ...
    private static void generateSelfSignedCertificate(final String alias,
                                                     ...
                                                     final String keyEntryPassword) {
        try {
            final KeyPairGenerator keyGen = KeyPairGenerator.getInstance(KEY_PAIR_GENERATOR_ALGORITHM, PROVIDER);
    ...
    private static X509Certificate buildCertificate(final String commonName, final String ipAddress,
        ...
        final X509Certificate cert = new JcaX509CertificateConverter().setProvider(KEY_STORE_PROVIDER)
